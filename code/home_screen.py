...
class HomeScreen(BaseScreen):
    ...
    def create(self):
        ...
        note_text_2.add_style(STYLE_SCREEN.style_siyuan_18_black, lv.PART.MAIN | lv.STATE.DEFAULT)
        ...
        communication_status.set_size(100, 20)
        communication_status.set_text("通讯状态:")
        communication_status.set_long_mode(lv.label.LONG.WRAP)
        communication_status.set_style_text_align(lv.TEXT_ALIGN.LEFT, 0)
        communication_status.add_style(STYLE_SCREEN.style_siyuan_18_black, lv.PART.MAIN | lv.STATE.DEFAULT)

        communication_status_info = lv.label(view_module)
        communication_status_info.set_pos(110, 10)
        communication_status_info.set_size(160, 20)
        communication_status_info.set_text("WLAN-在线")
