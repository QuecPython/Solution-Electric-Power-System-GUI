...
class ConnectInfoScreen(BaseScreen):
    ...
    def create(self):
        ...
        normal_view_text.set_text("正常")
        normal_view_text.set_long_mode(lv.label.LONG.WRAP)
        normal_view_text.set_style_text_align(lv.TEXT_ALIGN.CENTER, 0)
        normal_view_text.add_style(STYLE_SCREEN.style_siyuan_16_green, lv.PART.MAIN | lv.STATE.DEFAULT)
        ...
        re_check_btn_text.set_text("重新诊断")
        re_check_btn_text.set_long_mode(lv.label.LONG.WRAP)
        re_check_btn_text.set_style_text_align(lv.TEXT_ALIGN.CENTER, 0)
        re_check_btn_text.add_style(STYLE_SCREEN.style_siyuan_18_white, lv.PART.MAIN | lv.STATE.DEFAULT)
        ...
        net_mode_text.add_style(STYLE_SCREEN.style_siyuan_18_black, lv.PART.MAIN | lv.STATE.DEFAULT)

        net_mode_lable = lv.label(self.module2)
        net_mode_lable.set_pos(0, 150)
        net_mode_lable.set_size(230, 32)
        net_mode_lable.set_text("网络模式")
        net_mode_lable.set_long_mode(lv.label.LONG.WRAP)
        net_mode_lable.set_style_text_align(lv.TEXT_ALIGN.CENTER, 0)
        net_mode_lable.add_style(STYLE_SCREEN.style_siyuan_18_black, lv.PART.MAIN | lv.STATE.DEFAULT)
        ...
        signal_lable.set_text("信号强度")
        signal_lable.set_long_mode(lv.label.LONG.WRAP)
        signal_lable.set_style_text_align(lv.TEXT_ALIGN.CENTER, 0)
        signal_lable.add_style(STYLE_SCREEN.style_siyuan_18_black, lv.PART.MAIN | lv.STATE.DEFAULT)
        ...
        access_device_lable.set_text("接入设备")
        access_device_lable.set_long_mode(lv.label.LONG.WRAP)
        access_device_lable.set_style_text_align(lv.TEXT_ALIGN.CENTER, 0)
        access_device_lable.add_style(STYLE_SCREEN.style_siyuan_18_black, lv.PART.MAIN | lv.STATE.DEFAULT)

        self.modules.append(self.model_item_create((10, 610), "information.png", "信息"))
        self.modules.append(self.model_item_create((245, 610), "setting_32.png", "设置"))
        self.modules.append(self.model_item_create((10, 720), "upload.png", "上传数据"))
        self.modules.append(self.model_item_create((245, 720), "wifi_setting.png", "WiFi设置"))
    ...
    def model_item_create(self, pos, icon, name):
        ...
        name_text.add_style(STYLE_SCREEN.style_siyuan_18_grey, lv.PART.MAIN | lv.STATE.DEFAULT)
    ...
    def connect_check_box_create(self):
        ...
        wifi_setting_lable.set_text("正在检测设备接入...")
        wifi_setting_lable.set_long_mode(lv.label.LONG.WRAP)
        wifi_setting_lable.set_style_text_align(lv.TEXT_ALIGN.CENTER, 0)
        wifi_setting_lable.add_style(STYLE_SCREEN.style_siyuan_18_black, lv.PART.MAIN | lv.STATE.DEFAULT)
