...
class StyleScreen(object):
    ...
    def __init__(self):
        ...
        self.style_img = None
        self.style_montserrat_14_green = None
        self.style_montserrat_14_grey = None
        self.style_montserrat_14_orange = None
        self.style_montserrat_14_bg_orange = None
        self.style_montserrat_14_orange_btn = None
        self.style_montserrat_14_white = None
        self.style_montserrat_14_black = None
        self.style_montserrat_14_red = None
        self.style_montserrat_14_grey_border = None
        self.style_montserrat_14_green_border = None
    ...
    def __create_style(self):
        ...
        style_montserrat_14_green = lv.style_t()
        style_montserrat_14_green.init()
        style_montserrat_14_green.set_radius(0)
        style_montserrat_14_green.set_bg_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_green.set_bg_grad_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_green.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_green.set_bg_opa(0)
        style_montserrat_14_green.set_text_color(lv.color_make(0x29, 0xaa, 0x66))
        style_montserrat_14_green.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_green.set_text_letter_space(1)
        style_montserrat_14_green.set_pad_left(0)
        style_montserrat_14_green.set_pad_right(0)
        style_montserrat_14_green.set_pad_top(0)
        style_montserrat_14_green.set_pad_bottom(0)
        self.style_montserrat_14_green = style_montserrat_14_green

        style_montserrat_14_grey = lv.style_t()
        style_montserrat_14_grey.init()
        style_montserrat_14_grey.set_radius(0)
        style_montserrat_14_grey.set_bg_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_grey.set_bg_grad_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_grey.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_grey.set_bg_opa(0)
        style_montserrat_14_grey.set_text_color(lv.color_make(0x51, 0x51, 0x51))
        style_montserrat_14_grey.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_grey.set_text_letter_space(1)
        style_montserrat_14_grey.set_pad_left(0)
        style_montserrat_14_grey.set_pad_right(0)
        style_montserrat_14_grey.set_pad_top(0)
        style_montserrat_14_grey.set_pad_bottom(0)
        self.style_montserrat_14_grey = style_montserrat_14_grey

        style_montserrat_14_orange = lv.style_t()
        style_montserrat_14_orange.init()
        style_montserrat_14_orange.set_radius(0)
        style_montserrat_14_orange.set_bg_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_orange.set_bg_grad_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_orange.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_orange.set_bg_opa(0)
        style_montserrat_14_orange.set_text_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_orange.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_orange.set_text_letter_space(1)
        style_montserrat_14_orange.set_pad_left(0)
        style_montserrat_14_orange.set_pad_right(0)
        style_montserrat_14_orange.set_pad_top(0)
        style_montserrat_14_orange.set_pad_bottom(0)
        self.style_montserrat_14_orange = style_montserrat_14_orange

        style_montserrat_14_bg_orange = lv.style_t()
        style_montserrat_14_bg_orange.init()
        style_montserrat_14_bg_orange.set_radius(5)
        style_montserrat_14_bg_orange.set_bg_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_bg_orange.set_bg_grad_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_bg_orange.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_bg_orange.set_bg_opa(50)
        style_montserrat_14_bg_orange.set_text_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_bg_orange.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_bg_orange.set_text_letter_space(1)
        style_montserrat_14_bg_orange.set_pad_left(0)
        style_montserrat_14_bg_orange.set_pad_right(0)
        style_montserrat_14_bg_orange.set_pad_top(0)
        style_montserrat_14_bg_orange.set_pad_bottom(0)
        self.style_montserrat_14_bg_orange = style_montserrat_14_bg_orange

        style_montserrat_14_orange_btn = lv.style_t()
        style_montserrat_14_orange_btn.init()
        style_montserrat_14_orange_btn.set_radius(0)
        style_montserrat_14_orange_btn.set_bg_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_orange_btn.set_bg_grad_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_orange_btn.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_orange_btn.set_bg_opa(0)
        style_montserrat_14_orange_btn.set_text_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_orange_btn.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_orange_btn.set_border_color(lv.color_make(0xe9, 0x8f, 0x36))
        style_montserrat_14_orange_btn.set_border_width(2)
        style_montserrat_14_orange_btn.set_border_opa(255)
        style_montserrat_14_orange_btn.set_border_side(lv.BORDER_SIDE.BOTTOM)
        style_montserrat_14_orange_btn.set_text_letter_space(1)
        style_montserrat_14_orange_btn.set_pad_left(0)
        style_montserrat_14_orange_btn.set_pad_right(0)
        style_montserrat_14_orange_btn.set_pad_top(0)
        style_montserrat_14_orange_btn.set_pad_bottom(0)
        self.style_montserrat_14_orange_btn = style_montserrat_14_orange_btn

        style_montserrat_14_white = lv.style_t()
        style_montserrat_14_white.init()
        style_montserrat_14_white.set_radius(0)
        style_montserrat_14_white.set_bg_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_white.set_bg_grad_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_white.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_white.set_bg_opa(0)
        style_montserrat_14_white.set_text_color(lv.color_make(0xFF, 0xFF, 0xFF))
        style_montserrat_14_white.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_white.set_text_letter_space(1)
        style_montserrat_14_white.set_pad_left(0)
        style_montserrat_14_white.set_pad_right(0)
        style_montserrat_14_white.set_pad_top(0)
        style_montserrat_14_white.set_pad_bottom(0)
        self.style_montserrat_14_white = style_montserrat_14_white

        style_montserrat_14_black = lv.style_t()
        style_montserrat_14_black.init()
        style_montserrat_14_black.set_radius(0)
        style_montserrat_14_black.set_bg_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_black.set_bg_grad_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_black.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_black.set_bg_opa(0)
        style_montserrat_14_black.set_text_color(lv.color_make(0x00, 0x00, 0x00))
        style_montserrat_14_black.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_black.set_text_letter_space(1)
        style_montserrat_14_black.set_pad_left(0)
        style_montserrat_14_black.set_pad_right(0)
        style_montserrat_14_black.set_pad_top(0)
        style_montserrat_14_black.set_pad_bottom(0)
        self.style_montserrat_14_black = style_montserrat_14_black

        style_montserrat_14_red = lv.style_t()
        style_montserrat_14_red.init()
        style_montserrat_14_red.set_radius(0)
        style_montserrat_14_red.set_bg_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_red.set_bg_grad_color(lv.color_make(0x21, 0x95, 0xf6))
        style_montserrat_14_red.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_red.set_bg_opa(0)
        style_montserrat_14_red.set_text_color(lv.color_make(0xfa, 0x19, 0x28))
        style_montserrat_14_red.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_red.set_text_letter_space(1)
        style_montserrat_14_red.set_pad_left(0)
        style_montserrat_14_red.set_pad_right(0)
        style_montserrat_14_red.set_pad_top(0)
        style_montserrat_14_red.set_pad_bottom(0)
        self.style_montserrat_14_red = style_montserrat_14_red

        style_montserrat_14_grey_border = lv.style_t()
        style_montserrat_14_grey_border.init()
        style_montserrat_14_grey_border.set_radius(5)
        style_montserrat_14_grey_border.set_bg_color(lv.color_make(0xe6, 0xe6, 0xe6))
        style_montserrat_14_grey_border.set_bg_grad_color(lv.color_make(0xe6, 0xe6, 0xe6))
        style_montserrat_14_grey_border.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_grey_border.set_bg_opa(255)
        style_montserrat_14_grey_border.set_text_color(lv.color_make(0x51, 0x51, 0x51))
        style_montserrat_14_grey_border.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_grey_border.set_text_letter_space(1)
        style_montserrat_14_grey_border.set_border_color(lv.color_make(0x51, 0x51, 0x51))
        style_montserrat_14_grey_border.set_border_width(2)
        style_montserrat_14_grey_border.set_border_opa(128)
        style_montserrat_14_grey_border.set_pad_left(0)
        style_montserrat_14_grey_border.set_pad_right(0)
        style_montserrat_14_grey_border.set_pad_top(0)
        style_montserrat_14_grey_border.set_pad_bottom(0)
        self.style_montserrat_14_grey_border = style_montserrat_14_grey_border

        style_montserrat_14_green_border = lv.style_t()
        style_montserrat_14_green_border.init()
        style_montserrat_14_green_border.set_radius(5)
        style_montserrat_14_green_border.set_bg_color(lv.color_make(0x29, 0xaa, 0x66))
        style_montserrat_14_green_border.set_bg_grad_color(lv.color_make(0x29, 0xaa, 0x66))
        style_montserrat_14_green_border.set_bg_grad_dir(lv.GRAD_DIR.VER)
        style_montserrat_14_green_border.set_bg_opa(50)
        style_montserrat_14_green_border.set_text_color(lv.color_make(0x29, 0xaa, 0x66))
        style_montserrat_14_green_border.set_text_font(lv.font_montserrat_14)
        style_montserrat_14_green_border.set_text_letter_space(1)
        style_montserrat_14_green_border.set_border_color(lv.color_make(0x29, 0xaa, 0x66))
        style_montserrat_14_green_border.set_border_width(2)
        style_montserrat_14_green_border.set_border_opa(128)
        style_montserrat_14_green_border.set_pad_left(0)
        style_montserrat_14_green_border.set_pad_right(0)
        style_montserrat_14_green_border.set_pad_top(0)
        style_montserrat_14_green_border.set_pad_bottom(0)
        self.style_montserrat_14_green_border = style_montserrat_14_green_border
...
class BaseScreen:
    ...
    def header_create(self):
        ...
        time_text.add_style(STYLE_SCREEN.style_montserrat_14_black, lv.PART.MAIN | lv.STATE.DEFAULT)
        ...
        date_text.add_style(STYLE_SCREEN.style_montserrat_14_black, lv.PART.MAIN | lv.STATE.DEFAULT)
    ...
    def back_create(self):
        ...
        sn_text.add_style(STYLE_SCREEN.style_montserrat_14_black, lv.PART.MAIN | lv.STATE.DEFAULT)
    ...
    def menu_create(self):
        ...
        self.bottom_menu_item_create(44, "menu_home.png", "menu_home_checked.png", "HomeScreen", "Home")
        self.bottom_menu_item_create(164, "menu_information.png", "menu_information_checked.png", "InformationScreen", "Information")
        self.bottom_menu_item_create(284, "menu_alarm.png", "menu_alarm_checked.png", "AlarmScreen", "Alarm")
        self.bottom_menu_item_create(404, "menu_setting.png", "menu_setting_checked.png", "SettingScreen", "Setting")
    ...
    def bottom_menu_item_create(self, pos_x, img, checked_img, menu_code, menu_name):
        ...
        menu_text.set_pos(pos_x - 40, 50)
        menu_text.set_size(120, 20)
        ...
        menu_text.add_style(
            (STYLE_SCREEN.style_montserrat_14_grey if self.name != menu_code else STYLE_SCREEN.style_montserrat_14_orange), lv.PART.MAIN | lv.STATE.DEFAULT
        )
