...
class SelectConnectMethodScreen(BaseScreen):
    ...
    def create(self):
        ...
        lable_text.set_text("Choose connect method")
        ...
        connect_method_bluetooth_text.set_size(330, 41)
        connect_method_bluetooth_text.set_text("Bluetooth connect")
        ...
        connect_method_wifi_text.set_size(330, 41)
        connect_method_wifi_text.set_text("WiFi connect")
